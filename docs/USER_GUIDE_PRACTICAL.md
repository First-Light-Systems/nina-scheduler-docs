...
1. **Access the web interface** at your organization's Science Scheduler URL
...
**Installation Steps**:
1. Download the Science Scheduler plugin from your organization
...
4. Enter connection settings:
   - **Server URL**: Provided by your organization (e.g., `http://scheduler.yourobs.edu`)
...
- Refer to this guide
- Contact your organization's Science Scheduler administrator
- Check for updated documentation at your organization's website
