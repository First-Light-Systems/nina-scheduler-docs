...
The ObservationFiles page provides access to all files captured during an observation. You can view metadata, preview images, and download files individually or in bulk.

---

## Accessing Observation Files

1. Navigate to **My Observations** or the observation list
2. Click on a **completed** observation to view its details
3. Click the **Files** tab or **View Files** button
4. The ObservationFiles page opens showing all captured files
