...
This guide provides step-by-step instructions for common tasks in Asterism.
...
1. **Access the web interface** at your institution's Asterism URL
...
Asterism supports five observation types. The three most commonly used are described in detail below; **Rise to Set** and **Monitoring** are summarized after them.
...
Asterism can send you email and/or Pushover push notifications when your observations change state.
...
**Installation Steps**:
1. Download the Asterism plugin from your institution
...
The plugin adds an **Asterism** container to NINA's Advanced Sequencer:

**Adding to Sequence**:
1. Open NINA's **Advanced Sequencer**
2. From the **Instructions** panel, find **Asterism** category
3. Drag **Asterism Container** into your sequence
...
4. Ensure NINA was running with Asterism container active
...
- Refer to this guide
- Contact your institution's Asterism administrator
...
Asterism monitors safety device status reported by each observatory. When a safety event occurs:
...
3. Contact your institution's Asterism administrator
